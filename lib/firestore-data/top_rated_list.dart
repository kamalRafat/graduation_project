...
class TopRatedListState extends State<TopRatedList> {
  ...
  String id = '';
  Future<String> countDocumentsInCollection(String collectionName) async {
  ...
  Future<String> dr() async {
    String collectionName = 'persontabel';
    id = await countDocumentsInCollection(collectionName);
    return id;
  }
